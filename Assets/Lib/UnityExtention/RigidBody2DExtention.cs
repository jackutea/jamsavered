...
namespace JackUtil {
    ...
    public static class RigidBody2DExtention {
        ...
        public static void MoveInPlatform(this Rigidbody2D _rig, float _xAxis,float _moveSpeed = 10.5f, float _accelerate = 0.018f, float _decelerate = 0.0032f, float _tentToSpeed = 0) {
            ...
            if (_xAxis != 0) {
                ...
                _rig.velocity = new Vector2(Mathf.SmoothDamp(_rig.velocity.x, _tentToSpeed * Time.fixedDeltaTime * 60, ref _xVec, _decelerate), _rig.velocity.y);
